    ...
    return (
      <div className="w-full ">
        <div  className="md:flex justify-between">
          <div className="w-[321px] md:w-[387px]">
            {/* ------- button div -------- */}
            <div className="flex gap-4">
              <button className={`px-4 h-[34px] md:h-fit md:py-[7px] border rounded-[100px] ${open === 1 ? 'bg-white font-semibold text-black border-[#EC6274]': 'bg-[#F4F4F4]'}`} 
              onClick={()=>handleOpen(1)}
              >
                Morning
              </button>
              <button className={`px-4 h-[34px] md:h-fit md:py-[7px] border rounded-[100px] ${open === 2 ? 'bg-white font-semibold text-black border-[#EC6274]': 'bg-[#F4F4F4]'}`} 
              onClick={()=>handleOpen(2)}
              >
                Afternoon
              </button>
              <button className={`px-4 h-[34px] md:h-fit md:py-[7px] border rounded-[100px] ${open === 3 ? 'bg-white font-semibold text-black border-[#EC6274]': 'bg-[#F4F4F4]'}`} 
            ...
            {/* ---------- activiti card 1 ----------- */}
            <div className={`h-[294px] rounded-[15px] border mt-[26px] ${open === 1 ? 'block':'hidden'}`}>
            ...
            {/* ---------- activiti card 1 ----------- */}
            <div className={`h-[294px] rounded-[15px] border mt-[26px] ${open === 2 ? 'block':'hidden'}`}>
            ...
            {/* ---------- activiti card 1 ----------- */}
            <div className={`h-[294px] rounded-[15px] border mt-[26px] ${open === 3 ? 'block':'hidden'}`}>
